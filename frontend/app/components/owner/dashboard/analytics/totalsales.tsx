...
export default function TotalSales() {
	return (
		<div className="bg-gray-100 rounded-2xl p-[3px] w-full border border-gray-300 hover:shadow-lg transition-shadow">
			...
			<div className="bg-white rounded-xl p-3 md:p-4 mb-3 border border-gray-300">
				...
				<div className="flex items-center gap-2 mb-1">
					<p className="text-xs md:text-sm text-gray-500">Sales</p>
					<span className="flex items-center gap-1">
						<span className="text-[10px] md:text-xs font-semibold" style={{ color: '#166534', backgroundColor: '#B2FF5E', padding: '2px 6px', borderRadius: '6px' }}>+12%</span>
					</span>
				</div>
					<span className="text-lg md:text-xl font-bold text-gray-900 truncate block">Rp 17.879.000</span>
				</div>
				</div>
			</div>
		...
		<div className="flex items-center justify-between px-2 pb-2">
			<span className="text-xs md:text-sm text-gray-600 truncate"><span className="font-semibold">+Rp 459k</span> from last year</span>
