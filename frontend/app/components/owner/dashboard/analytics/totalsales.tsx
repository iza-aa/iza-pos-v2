			...
			<div className="bg-white rounded-xl p-4 mb-3 border border-gray-300">
				...
				<div className="flex items-center gap-2 mb-1">
					...
					<span className="flex items-center gap-1">
						<span className="text-xs font-semibold" style={{ color: '#166534', backgroundColor: '#B2FF5E', padding: '2px 6px', borderRadius: '6px' }}>+12%</span>
					</span>
				</div>
					<span className="text-xl font-bold text-gray-900">Rp 17.879.000</span>
				</div>
				</div>
			</div>
