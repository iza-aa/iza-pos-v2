...
export default function RawMaterialsTab() {
  ...
  const confirmRestock = async (
    ...
    try {
      ...
      const totalCost = cost && cost > 0 ? cost * quantity : 0;
      const costNote =
        totalCost > 0 ? ` (Cost: ${formatRupiah(totalCost)})` : "";
      ...
      await fetchInventoryItems();
      showSuccess(`Successfully restocked ${item.name}`);
  ...
  return (
    <div className="flex flex-col h-full">
        ...
        <div className="flex flex-col lg:flex-row items-start lg:items-center justify-between gap-4">
          <div className="flex flex-col gap-1">
            ...
            <p className="text-xs md:text-sm text-gray-500">
              Manage your inventory stock and supplies
            </p>
          </div>
      ...
      <AdjustmentModal
        ...
        onAdjust={(itemId, newStock, reason) =>
          confirmAdjustment(itemId, newStock, reason, "")
        }
        item={adjustingItem}
      />
