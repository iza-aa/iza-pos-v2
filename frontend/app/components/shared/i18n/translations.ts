...
export const translations: Record<Language, Record<string, string>> = {
  en: {
    ...
    "dateRange.description": "Apply one period to every dated metric and chart in this tab.",
  ...
  id: {
    ...
    "dateRange.description": "Terapkan satu periode ke semua metrik dan grafik bertanggal di tab ini.",
