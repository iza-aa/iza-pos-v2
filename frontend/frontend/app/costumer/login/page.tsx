export default function LoginCostumerPage() {
  return (
    <main className="min-h-screen flex flex-col items-center justify-center bg-gradient-to-br from-[color:var(--color-primary)] to-white">

        <div className="text-white mb-5 font-bold text-3xl">
          <h1>Welcome User!</h1>
        </div>
